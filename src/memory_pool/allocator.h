#ifndef DLSYS_SRC_MEMORY_POOL_ALLOCATOR_H
#define DLSYS_SRC_MEMORY_POOL_ALLOCATOR_H
...
struct AllocationAttributes{
  ...
  AllocationAttributes(bool retry_after_failure, bool allocation_will_be_logged, 
